...
const InventoryManagement = () => {
  ...
  const getMeasureUnitName = (unitType) => {
    ...
    if (typeof unitType === 'object' && unitType !== null) {
      return unitType.name || unitType.unit_name || "";
    }
      ...
      render: (product) => (
        <div className={`flex items-center gap-3 ${isRTL ? "flex-row" : ""}`}>
          ...
          >
            ...
            {(product.product_no || product.sku) && (
              <div className="text-xs text-gray-500 dark:text-gray-400 truncate">
                {t("sku")}: {product.product_no || product.sku}
              </div>
            )}
            {product.barcode && (
              <div className="text-xs text-gray-500 dark:text-gray-400 truncate">
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <span className="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300">
                    {getCategoryName(selectedProduct.category || selectedProduct.categoryId)}
                  </span>
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-900 dark:text-white">
                    {getSupplierName(
                      selectedProduct.supplier_detail || selectedProduct.supplierId || selectedProduct.supplier
                    )}
                  </p>
                </div>
                <div>
