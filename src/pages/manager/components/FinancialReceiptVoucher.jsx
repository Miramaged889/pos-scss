...
const FinancialReceiptVoucher = () => {
  ...
  const handleEditReceipt = (receipt) => {
    ...
    // Initialize form fields with current receipt data
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6">
              {/* Receipt Preview */}
              <div className="mb-6">
                <div className="border-2 border-gray-300 dark:border-gray-600 rounded-lg p-6 bg-gray-50 dark:bg-gray-700">
                  <div className="text-center mb-4">
                    <h4 className="text-lg font-bold text-gray-900 dark:text-white">
                      {t("financialReceipt.title")}
                    </h4>
                  ...
                  {selectedReceipt.description && (
                    <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-600">
                      <div className="text-gray-600 dark:text-gray-200 mb-2 font-medium">
                        {t("description")}:
                      </div>
                      <div className="text-sm bg-white dark:bg-gray-600 p-3 rounded-lg dark:text-white">
                        {selectedReceipt.description}
                      </div>
                    </div>
                  )}
              ...
              <div className="flex items-center justify-between pt-4 border-t border-gray-200 dark:border-gray-700">
                ...
                <button
                  onClick={() => setIsViewModalOpen(false)}
                  className="px-4 py-2 text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors"
                >
                  {t("close")}
                </button>
              </div>
            ...
            <div className="p-6">
              <form
                onSubmit={(e) => {
                  ...
                  handleUpdateReceipt(updatedReceipt);
                }}
                className="space-y-6"
              >
                {/* Amount */}
                ...
                <div className="flex items-center justify-end space-x-3 rtl:space-x-reverse pt-4 border-t border-gray-200 dark:border-gray-700">
                  ...
                  >
                    ...
                    {t("financialReceipt.updateReceipt")}
                  </button>
                </div>
              </form>
            </div>
