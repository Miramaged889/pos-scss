...
const resources = {
  ar: {
    translation: {
      ...
      markAsReady: "تم الإنجاز",
      markAsDelivered: "تم التوصيل",
      orderWillBeMarkedPreparing: "سيتم تحديد الطلب كقيد التحضير",
      ...
      addNotesAboutOrder: "أضف ملاحظات حول الطلب",
      optional: "اختياري",
      ...
      delayedOrder: "طلب متأخر",
      updateStatus: "تحديث الحالة",
      autoRefreshNotification: "يتم تحديث الطلبات تلقائياً كل 20 ثانية",
      ...
      ordersNeedAttention: "طلبات تحتاج انتباه",
      highOrderVolume: "حجم طلبات عالي",

      // Waste Log
      wasteLog: "سجل الإهدار",
      addWasteItem: "إضافة عنصر مهدر",
      totalWasteCost: "إجمالي تكلفة الإهدار",
      todayWaste: "إهدار اليوم",
      wasteItems: "عناصر الإهدار",
      ...
      dropped: "سقط",
      other: "أخرى",
      noWasteItems: "لا توجد عناصر مهدرة",
      ...
      performanceAnalyticsAndInsights: "تحليلات الأداء والرؤى",
      ...
      busiest: "الأكثر ازدحاماً",
      efficiency: "الكفاءة",
      goodPrepTime: "وقت تحضير جيد",
      improvePrepTime: "تحسين وقت التحضير",
      recommendations: "التوصيات",
      optimizeForPeakHours: "تحسين لساعات الذروة",

      // Kitchen Settings
      kitchenSettings: "إعدادات المطبخ",
      customizeKitchenExperience: "تخصيص تجربة المطبخ",
      resetToDefaults: "إعادة تعيين للافتراضي",
      saveSettings: "حفظ الإعدادات",
      appearance: "المظهر",
      theme: "المظهر",
      chooseDarkOrLightMode: "اختر الوضع المظلم أو المضيء",
      selectInterfaceLanguage: "اختر لغة الواجهة",
      compactView: "عرض مضغوط",
      showMoreOrdersInLessSpace: "عرض المزيد من الطلبات في مساحة أقل",
      playNotificationSounds: "تشغيل أصوات الإشعارات",
      test: "اختبار",
      volume: "مستوى الصوت",
      priorityAlerts: "تنبيهات الأولوية",
      highlightDelayedOrders: "تمييز الطلبات المتأخرة",
      priorityThreshold: "عتبة الأولوية",
      enableAutoRefresh: "تمكين التحديث التلقائي",
      automaticallyUpdateOrders: "تحديث الطلبات تلقائياً",
      refreshInterval: "فترة التحديث",
      seconds: "ثواني",
      display: "العرض",
      maxOrdersPerView: "الحد الأقصى للطلبات لكل عرض",
      showCustomerPhone: "عرض هاتف العميل",
      displayPhoneInOrderCards: "عرض الهاتف في بطاقات الطلب",
      showOrderNotes: "عرض ملاحظات الطلب",
      displayNotesInOrderCards: "عرض الملاحظات في بطاقات الطلب",
      confirmStatusUpdates: "تأكيد تحديثات الحالة",
      showConfirmationDialog: "عرض حوار التأكيد",
      unsavedChangesWarning: "يوجد تغييرات غير محفوظة. تذكر حفظ الإعدادات.",
    },
  },
  en: {
    translation: {
